...
- **Delete item** in red at the bottom of the details panel — removes the item's folder from disk after a confirmation. This cannot be undone. With several items selected, the *Delete* button in the selection bar removes them all after one confirmation.
